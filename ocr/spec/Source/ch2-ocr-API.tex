...
\hypertarget{func_ocrGetArgc}{
  \index{Supporting functions@{Supporting function}!ocrGet\-Argc@{ocrGet\-Argc}}
  \subsection[{ocrGet\-Argc}]{\setlength{\rightskip}{0pt plus 5cm}{\bf u64} ocrGet\-Argc(
\begin{DoxyParamCaption}
...
\hypertarget{func_ocrGetArgv}{
  \index{Supporting functions@{Supporting function}!ocrGet\-Argv@{get\-Argv}}
  \subsection[{ocrGet\-Argv}]{\setlength{\rightskip}{0pt plus 5cm}{\bf char $\ast$} ocrGet\-Argv(
\begin{DoxyParamCaption}
\item[{void $\ast$}]{db\-Ptr}
\item[{{\bf u64}}]{index}
\end{DoxyParamCaption}
