    ...
    case OCR_TRACE_TYPE_EDT:
        ...
        switch(trace->actionSwitch){
            ...
            case OCR_ACTION_TEMPLATE_CREATE:
            {
                ...
                printf("[TRACE] U/R: %s | PD: 0x%"PRIx64" | WORKER_ID: %"PRIu64" | EDT: "GUIDF"  | TIMESTAMP: %"PRIu64" | TYPE: EDT | ACTION: TEMPLATE_CREATE | GUID: "GUIDF" | FUNC_PTR: %"PRIx64"\n",
    ...
    case OCR_TRACE_TYPE_API_EDT:
        ...
        switch(trace->actionSwitch){
            ...
            case OCR_ACTION_TEMPLATE_CREATE:
            {
                ...
                printf("[TRACE] U/R: %s | PD: 0x%"PRIx64" | WORKER_ID: %"PRIu64" | EDT: "GUIDF" | TIMESTAMP: %"PRIu64" | TYPE: API_EDT | ACTION: TEMPLATE_CREATE | FUNC_PTR: %p | DEPC: %"PRId32" | PARAMC: %"PRId32"\n",
